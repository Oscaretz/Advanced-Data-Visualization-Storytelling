...
load_css(Path("dashboard/assets/style.css"))
...
with tab1:
    ...
    if analysis == "Random Walk Test":
        st.image(f"dashboard/graphs/BNB_RWvsS_{crypto}.png", caption=f"Random Walk vs Serie ({crypto})")
        st.write("Interpretation of random walk test...")
    elif analysis == "Autocorrelation":
        st.image(f"dashboard/graphs/ACF_{crypto}.png", caption=f"Autocorrelation of Returns ({crypto})")
    elif analysis == "Volatility":
        st.image(f"dashboard/graphs/VOL_{crypto}.png")
        st.image(f"dashboard/graphs/VOLU_{crypto}.png")
        st.image(f"dashboard/graphs/VOLCOR_{crypto}.png")
